...
Addon.ClassData["DEATHKNIGHT"] = {
    ...
    [250] = {
        ...
        weights = {
            ...
            ["Mythic+"]      = { PRIMARY = 1.20, HASTE = 0.98, VERS = 0.65, MASTERY = 0.91, CRIT = 1.05, STAMINA = 1.00, LEECH = 0.15, SPEED = 0.06, AVOIDANCE = 0.12, WEAPON_DPS = 3.5, SOCKET_VALUE = 70 },
            ["Raid"]         = { PRIMARY = 1.20, CRIT = 1.05, HASTE = 1.04, MASTERY = 0.83, VERS = 0.65, STAMINA = 1.00, LEECH = 0.15, SPEED = 0.06, AVOIDANCE = 0.12, WEAPON_DPS = 3.5, SOCKET_VALUE = 70 },
        },
        trinkets = {
            ["Leveling"] = {
                ["S"] = {},
    ...
    [251] = {
        ...
        weights = {
            ...
            ["Mythic+"]      = { PRIMARY = 1.50, MASTERY = 0.98, CRIT = 1.05, HASTE = 0.85, VERS = 0.65, STAMINA = 0.00, LEECH = 0.08, SPEED = 0.04, AVOIDANCE = 0.10, WEAPON_DPS = 6.0, SOCKET_VALUE = 65 },
            ["Raid"]         = { PRIMARY = 1.50, MASTERY = 0.99, CRIT = 1.05, HASTE = 0.84, VERS = 0.65, STAMINA = 0.00, LEECH = 0.08, SPEED = 0.04, AVOIDANCE = 0.10, WEAPON_DPS = 6.0, SOCKET_VALUE = 65 },
        },
        trinkets = {
            ["Leveling"] = {
                ["S"] = {},
    ...
    [252] = {
        ...
        weights = {
            ...
            ["Mythic+"]      = { PRIMARY = 1.50, MASTERY = 1.05, CRIT = 1.02, HASTE = 0.85, VERS = 0.65, STAMINA = 0.00, LEECH = 0.08, SPEED = 0.04, AVOIDANCE = 0.10, WEAPON_DPS = 5.0, SOCKET_VALUE = 65 },
            ["Raid"]         = { PRIMARY = 1.50, MASTERY = 1.05, CRIT = 1.02, HASTE = 0.84, VERS = 0.65, STAMINA = 0.00, LEECH = 0.08, SPEED = 0.04, AVOIDANCE = 0.10, WEAPON_DPS = 5.0, SOCKET_VALUE = 65 },
        },
        trinkets = {
            ["Leveling"] = {
                ["S"] = {},
