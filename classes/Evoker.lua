...
Addon.ClassData["EVOKER"] = {
    ...
    [1468] = {
        ...
        weights = {
            ...
            ["Mythic+"]      = { PRIMARY = 1.60, HASTE = 0.85, CRIT = 0.87, MASTERY = 1.05, VERS = 0.65, STAMINA = 0.40, LEECH = 0.12, SPEED = 0.05, AVOIDANCE = 0.10, WEAPON_DPS = 1.5, SOCKET_VALUE = 65 },
            ["Raid"]         = { PRIMARY = 1.60, MASTERY = 1.05, HASTE = 1.02, CRIT = 1.00, VERS = 0.65, STAMINA = 0.40, LEECH = 0.12, SPEED = 0.05, AVOIDANCE = 0.10, WEAPON_DPS = 1.5, SOCKET_VALUE = 65 },
        },
        trinkets = {
            ["Leveling"] = {
                ["S"] = {},
