...
Addon.ClassData["SHAMAN"] = {
    ...
    [262] = {
        ...
        weights = {
            ...
            ["Mythic+"]      = { PRIMARY = 1.50, MASTERY = 1.05, HASTE = 0.86, CRIT = 0.90, VERS = 0.65, STAMINA = 0.00, LEECH = 0.08, SPEED = 0.04, AVOIDANCE = 0.10, WEAPON_DPS = 5.0, SOCKET_VALUE = 65 },
            ["Raid"]         = { PRIMARY = 1.50, MASTERY = 1.05, HASTE = 0.84, CRIT = 0.89, VERS = 0.65, STAMINA = 0.00, LEECH = 0.08, SPEED = 0.04, AVOIDANCE = 0.10, WEAPON_DPS = 5.0, SOCKET_VALUE = 65 },
        },
        trinkets = {
            ["Leveling"] = {
                ["S"] = {},
    ...
    [263] = {
        ...
        weights = {
            ...
            ["Mythic+"]      = { PRIMARY = 1.50, HASTE = 0.96, MASTERY = 1.05, CRIT = 0.77, VERS = 0.65, STAMINA = 0.00, LEECH = 0.08, SPEED = 0.04, AVOIDANCE = 0.10, WEAPON_DPS = 5.5, SOCKET_VALUE = 65 },
            ["Raid"]         = { PRIMARY = 1.50, HASTE = 0.93, MASTERY = 1.05, CRIT = 0.74, VERS = 0.65, STAMINA = 0.00, LEECH = 0.08, SPEED = 0.04, AVOIDANCE = 0.10, WEAPON_DPS = 5.5, SOCKET_VALUE = 65 },
        },
        trinkets = {
            ["Leveling"] = {
                ["S"] = {},
    ...
    [264] = {
        ...
        weights = {
            ...
            ["Mythic+"]      = { PRIMARY = 1.60, HASTE = 0.79, CRIT = 1.05, MASTERY = 0.73, VERS = 0.65, STAMINA = 0.40, LEECH = 0.12, SPEED = 0.05, AVOIDANCE = 0.10, WEAPON_DPS = 1.5, SOCKET_VALUE = 65 },
            ["Raid"]         = { PRIMARY = 1.60, HASTE = 0.75, CRIT = 1.05, VERS = 0.65, MASTERY = 0.72, STAMINA = 0.40, LEECH = 0.12, SPEED = 0.05, AVOIDANCE = 0.10, WEAPON_DPS = 1.5, SOCKET_VALUE = 65 },
        },
        trinkets = {
            ["Leveling"] = {
                ["S"] = {},
